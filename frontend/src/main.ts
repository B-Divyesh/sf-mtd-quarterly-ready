...
handleLicenseReturn();
route();
void fetch('/health').then(response => response.ok ? response.json() : null).then((health: { hmrc_integration_configured?: boolean } | null) => {
